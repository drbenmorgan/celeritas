...
//---------------------------------------------------------------------------//
/*!
 * Device data for creating a SeltzerBergerInteractor.
 */
struct SeltzerBergerPointers
{
    //! Model ID
    ModelId model_id;
...
void seltzer_berger_interact(const SeltzerBergerPointers& device_pointers,
