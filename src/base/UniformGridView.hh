 ...
 *
 * This simple class is used by physics vectors. Currently the only
 */
class UniformGridView
{
  public:
    //@{
    //! Type aliases
  ...
  public:
    ...
    UniformGridView(const UniformGridPointers& data);
